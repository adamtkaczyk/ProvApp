...
public class ProvAppAuthenticator extends AbstractAccountAuthenticator {

    private String TAG = "ProvAppAuthenticator";
    ...
    public Bundle getAuthToken(AccountAuthenticatorResponse response, Account account, String authTokenType, Bundle options) throws NetworkErrorException {
        ...
        Log.d("provapp", TAG + "> getAuthToken");
        ...
        Log.d("provapp", TAG + "> peekAuthToken returned - " + authToken);
