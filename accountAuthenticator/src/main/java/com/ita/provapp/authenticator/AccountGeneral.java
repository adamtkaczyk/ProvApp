...
public class AccountGeneral {
     ...
     * Account type id
     */
    public static final String ACCOUNT_TYPE = "com.ita.provapp.authenticator";
    ...
    public static final ServerAuthenticate sServerAuthenticate = new ProvAppServerAuthenticate();
